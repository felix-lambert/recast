...
var Message = function Message(body, recastToken) {
  ...
  this.addReply = function (replies) {
    ...
    console.log(replies)
    console.log('//////////////////////////////')
    _this._messageStack = _this._messageStack.concat(replies)
    console.log('message stack')
    console.log(_this._messageStack)
    return _this._messageStack
  };
  ...
  this.reply = function () {
    ...
    console.log(_this.conversationId)
    console.log(_this.recastToken)
    console.log(messages)

    return agent('POST', _constants2.default.MESSAGE_ENDPOINT.replace(':conversation_id', _this.conversationId)).set('Authorization', 'Token ' + _this.recastToken).send({ messages: messages });
  };
